...
With Universal Forwarders and Sysmon set up and successfully logging and monitoring domain activity, it would make for a suitable SIEM solution, giving security professionals and incident response a deeper insight into the details of suspicious domain activity.
